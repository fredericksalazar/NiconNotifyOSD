...
public class UbuntuFont {
    ...
    private static UbuntuFont font;
    ...
    private UbuntuFont(){
        urlFont="/nicon/notify/core/font/Ubuntu-R.ttf";
            try{
               System.out.println("Loading font from: "+urlFont);
               in=getClass().getResourceAsStream(urlFont); 
               System.out.println("The Font Ubuntu Light has been Load ...");
